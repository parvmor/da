...
for i in `seq 1 5`
do
    #valgrind --leak-check=full --show-leak-kinds=all --track-origins=yes --verbose --log-file=leaks1/leak$j-$i.txt ./da_proc $i membership 300000 &
    #valgrind --tool=helgrind --log-file=leaks2/leak$j-$i.txt ./da_proc $i membership 300000 &
